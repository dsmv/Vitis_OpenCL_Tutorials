...
#
# Generated by export_simulation on Mon Nov 09 06:13:44 EST 2020
#
################################################################################
...
'-reset_run' switch to the './convolve_fpga_0.sh' script.

./convolve_fpga_0.sh -reset_run
...
./convolve_fpga_0.sh -noclean_files

For more information on the script, please type './convolve_fpga_0.sh -help'.
