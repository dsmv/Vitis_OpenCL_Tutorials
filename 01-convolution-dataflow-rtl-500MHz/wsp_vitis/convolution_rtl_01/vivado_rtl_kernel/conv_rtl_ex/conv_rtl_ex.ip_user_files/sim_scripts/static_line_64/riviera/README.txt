...
#
# Generated by export_simulation on Tue Nov 10 00:01:57 EST 2020
#
################################################################################
...
'-reset_run' switch to the './static_line_64.sh' script.

./static_line_64.sh -reset_run
...
./static_line_64.sh -noclean_files

For more information on the script, please type './static_line_64.sh -help'.
