...
#
# Generated by export_simulation on Mon Nov 09 06:21:17 EST 2020
#
################################################################################
...
'-reset_run' switch to the './axi_interconnect_32_64.sh' script.

./axi_interconnect_32_64.sh -reset_run
...
./axi_interconnect_32_64.sh -noclean_files

For more information on the script, please type './axi_interconnect_32_64.sh -help'.
