...
#
# Generated by export_simulation on Mon Nov 09 06:13:52 EST 2020
#
################################################################################
...
'-reset_run' switch to the './static_line_1.sh' script.

./static_line_1.sh -reset_run
...
./static_line_1.sh -noclean_files

For more information on the script, please type './static_line_1.sh -help'.
