...
#
# Generated by export_simulation on Mon Nov 09 06:13:49 EST 2020
#
################################################################################
...
'-reset_run' switch to the './static_line_32.sh' script.

./static_line_32.sh -reset_run
...
./static_line_32.sh -noclean_files

For more information on the script, please type './static_line_32.sh -help'.
