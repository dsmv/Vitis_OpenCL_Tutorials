...
//    convolve_kernel.setArg(5, args.height);
    ...
    convolve_kernel.setArg(0, coefficient_size);
    convolve_kernel.setArg(1, args.width);
    convolve_kernel.setArg(2, args.height);
    convolve_kernel.setArg(3, buffer_input);
    convolve_kernel.setArg(4, buffer_output);
    convolve_kernel.setArg(5, buffer_coefficient);
