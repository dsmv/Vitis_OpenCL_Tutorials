...
proc edit_core {core} {
  set bif      [::ipx::get_bus_interfaces -of $core  "gmem1"] 
  ...
  set bif      [::ipx::get_bus_interfaces -of $core  "gmem2"] 
  set bifparam [::ipx::add_bus_parameter -quiet "MAX_BURST_LENGTH" $bif]
  set_property value        256          $bifparam
  set_property value_source constant     $bifparam
  set bifparam [::ipx::add_bus_parameter -quiet "NUM_READ_OUTSTANDING" $bif]
  ...
  set bif      [::ipx::get_bus_interfaces -of $core  "gmem3"] 
  set bifparam [::ipx::add_bus_parameter -quiet "MAX_BURST_LENGTH" $bif]
  set_property value        256          $bifparam
  set_property value_source constant     $bifparam
  set bifparam [::ipx::add_bus_parameter -quiet "NUM_READ_OUTSTANDING" $bif]
  ...
  ::ipx::associate_bus_interfaces -busif "gmem1" -clock "ap_clk" $core
  ::ipx::associate_bus_interfaces -busif "gmem2" -clock "ap_clk" $core
  ::ipx::associate_bus_interfaces -busif "gmem3" -clock "ap_clk" $core
  ...
  set reg      [::ipx::add_register -quiet "coefficient_size" $addr_block]
  ...
  set reg      [::ipx::add_register -quiet "inFrame" $addr_block]
  set_property address_offset 0x028 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value gmem1 $regparam 

  set reg      [::ipx::add_register -quiet "outFrame" $addr_block]
  set_property address_offset 0x034 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value gmem2 $regparam 

  set reg      [::ipx::add_register -quiet "coefficient" $addr_block]
  set_property address_offset 0x040 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value gmem3 $regparam 
...
proc package_project {path_to_packaged kernel_vendor kernel_library kernel_name} {
  ...
  foreach user_parameter [list C_S_AXI_CONTROL_ADDR_WIDTH C_S_AXI_CONTROL_DATA_WIDTH C_GMEM1_ADDR_WIDTH C_GMEM1_DATA_WIDTH C_GMEM2_ADDR_WIDTH C_GMEM2_DATA_WIDTH C_GMEM3_ADDR_WIDTH C_GMEM3_DATA_WIDTH] {
